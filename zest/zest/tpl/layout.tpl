...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ROOT}}content/themes/{{THEME}}/css/style.css" />
    ...
    <body>
        <header id="header-wrapper">
            <div id="header">
                <a href="{{ROOT}}"><img src="{{ROOT}}content/themes/{{THEME}}/img/logo.png" title="{{site_name}}" alt="{{site_name}}"/></a>
